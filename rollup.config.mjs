...
const buildConfig = {
	...
	copy: [
		...
		{
			src: 'node_modules/pvs/dist/pvs-navigation.min.js',
			dest: 'assets/vendors',
		},
		{ src: 'node_modules/pvs/dist/pvs-filter.min.js', dest: 'assets/vendors' },
		{
			src: 'node_modules/pvs/dist/pvs-page-loader.min.css',
			dest: 'assets/vendors',
		},
		{
			src: 'node_modules/pvs/dist/pvs-page-loader.min.js',
			dest: 'assets/vendors',
		},
		// Geist font
		{
		...
		// Partials
		{
			src: ['node_modules/pvs/partials/*.hbs', '!**/pricing.hbs'],
			dest: 'partials',
		},
	],
};
